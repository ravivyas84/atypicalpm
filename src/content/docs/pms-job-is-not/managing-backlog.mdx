...
Management is purely a side quest, the backlog is the documented output of all your efforts of talking to consumers, looking at data and your prioritization process, including what should not be picked up.
