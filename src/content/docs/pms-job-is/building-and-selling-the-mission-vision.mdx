...
description: The Job of a PM is to build and sell the Vision
contributors:
  - name: "Ravi Vyas"
...
- It also provides a prioritization function to everyone, anything that does not help the mission and vison has a low priority
